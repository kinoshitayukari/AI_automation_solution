...
const ContactSection: React.FC<ContactSectionProps> = ({ id }) => {
  ...
  // Set initial inquiry type based on navigation state
  useEffect(() => {
  ...
  if (isSubmitted) {
    return (
      <section id={id} className="py-24 bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-lg max-w-lg w-full text-center">
          ...
          <button 
            ...
            className="text-brand-dark underline hover:text-brand-light"
          >
            フォームに戻る
          </button>
        </div>
    ...
    <section id={id} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">お問い合わせ・無料体験</h2>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="block w-full rounded-lg border-gray-300 bg-gray-50 border p-4 focus:border-brand-accent focus:ring-brand-accent appearance-none text-lg"
                  required
                >
            ...
            <div className="pt-4 text-center">
              <button
                type="submit"
                className="w-full md:w-auto min-w-[300px] bg-brand-dark hover:bg-gray-800 text-white font-bold py-4 px-12 rounded-full shadow-lg transition-transform transform hover:scale-[1.01] inline-flex items-center justify-center gap-2 text-lg"
              >
                送信する <Send size={20} />
              </button>
            </div>
